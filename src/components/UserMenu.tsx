    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-56" align="end" forceMount>
          ...
          <DropdownMenuItem className="cursor-pointer" onClick={() => handleVotar("estado")}>
          ...
          <DropdownMenuItem className="cursor-pointer" onClick={() => handleVotar("historial")}>
          ...
          <DropdownMenuItem className="cursor-pointer" onClick={() => handleVotar("configuracion")}>
