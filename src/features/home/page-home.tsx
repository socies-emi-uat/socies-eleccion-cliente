...
const CONTRACT_ADDRESS = '0x3619F576Ec70d3a2B5147944A1CB4CF76b76a426';
const ABI = ['function getAdmin() view returns (address)'];
        ...
        <p className="text-sm text-muted-foreground mb-2">
          {cuenta ? (
            <>
              ...
              {isAdmin && <strong className="text-green-600">(Admin)</strong>}
            </>
          ) : (
